...
class AppFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $this->createUsers(80, $manager);              // création de 300 utilisateurs exemples
        $this->createCategories(10, $manager);          // création de 10 catégories exemples
        $this->createProducts(300, $manager);          // création de 1500 produits exemples
        $this->createPaniers(150, $manager);            // création de 600 paniers exemples
        $this->createAvis(58, $manager);              // création de 1000 avis exemples
